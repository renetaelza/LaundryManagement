...
public class KaryawanManagement extends javax.swing.JPanel {
    Boolean hasil;
    ...
    private void getData() {
        ...
        List<Karyawan> listKaryawan = karyawanService.findAll();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Master Data > Kelola Karyawan");
        ...
        tabelKaryawan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID KARYAWAN", "NAMA", "ALAMAT", "NOMOR TELEPON"
            }
        ));
        ...
        jLabel12.setText("Manage Karyawan");
                ...
                .addGroup(rounded2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(rounded2Layout.createSequentialGroup()
                        ...
                        .addGroup(rounded2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_nama, javax.swing.GroupLayout.PREFERRED_SIZE, 716, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void tabelKaryawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelKaryawanMouseClicked
        ...
        id = Integer.parseInt(tabelKaryawan.getValueAt(row, 0).toString());
        nama = tabelKaryawan.getValueAt(row, 1).toString();
        alamat = tabelKaryawan.getValueAt(row, 2).toString();
        nomorTelepon = tabelKaryawan.getValueAt(row, 3).toString();
    ...
    private Karyawan findKaryawan(int id) {
        Karyawan karyawan = new Karyawan();
        karyawanService = new KaryawanServiceImpl();
        karyawan = karyawanService.findById(id);
    ...
    private void btnSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSearchMouseClicked
        ...
        searchedKaryawan = findKaryawan(id);
    ...
    private void btnTextSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTextSaveMouseClicked
        ...
        JOptionPane.showMessageDialog(null, "Data karyawan created successfully");
        loadData2();
        emptyField();
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        JOptionPane.showMessageDialog(null, "Data karyawan updated successfully");
        loadData2();
        emptyField();
    ...
    private void btnPrintMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPrintMouseClicked
        // TODO add your handling code here:
        MessageFormat header = new MessageFormat("List Karyawan");
    ...
    private void loadData(Karyawan karyawan) {
        Object[][] objectKaryawan = new Object[1][4];
        
        objectKaryawan[0][0] = karyawan.getId();
        objectKaryawan[0][1] = karyawan.getNama();
        objectKaryawan[0][2] = karyawan.getAlamat();
        objectKaryawan[0][3] = karyawan.getNomorTelepon();
    ...
    private void loadData2() {
        ...
        Object[][] objectKaryawan = new Object[listKaryawan.size()][4];
        
        int counter = 0;
        
        for (Karyawan karyawan : listKaryawan) {
            objectKaryawan[counter][0] = karyawan.getId();
            objectKaryawan[counter][1] = karyawan.getNama();
            objectKaryawan[counter][2] = karyawan.getAlamat();
            objectKaryawan[counter][3] = karyawan.getNomorTelepon();
            counter++;
        }
        tabelKaryawan.setModel(new javax.swing.table.DefaultTableModel(
            objectKaryawan,
