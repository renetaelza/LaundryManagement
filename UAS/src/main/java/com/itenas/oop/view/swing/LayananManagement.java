...
public class LayananManagement extends javax.swing.JPanel {
    Boolean hasil;
    LayananService layananService = new LayananServiceImpl();
    private DefaultTableModel model;
    
    public LayananManagement() {
        initComponents();
        model = new DefaultTableModel();
        tabelLayanan.setModel(model);
    ...
    private void getData() {
        DefaultTableModel dtm = (DefaultTableModel) tabelLayanan.getModel();
        dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Master Data > Kelola Layanan");
        ...
        jLabel12.setText("Manage Layanan");
        jLabel12.setToolTipText("");

        jLabel11.setBackground(new java.awt.Color(0, 0, 0));
        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText("ID Layanan");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, rounded2Layout.createSequentialGroup()
                        ...
                        .addGroup(rounded2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(rounded2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txt_nama, javax.swing.GroupLayout.DEFAULT_SIZE, 470, Short.MAX_VALUE)
    ...
    private void tabelLayananMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelLayananMouseClicked
        ...
        id = Integer.parseInt(tabelLayanan.getValueAt(row, 0).toString());
        nama = tabelLayanan.getValueAt(row, 1).toString();
        harga = Integer.parseInt(tabelLayanan.getValueAt(row, 2).toString());
    ...
    private Layanan findLayanan(int id) {
        Layanan layanan = new Layanan();
        layananService = new LayananServiceImpl();
        layanan = layananService.findById(id);
    ...
    private void btnSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSearchMouseClicked
        ...
        searchedLayanan = findLayanan(id);
        if (searchedLayanan != null) {
            loadData(searchedLayanan);
        } else {
    ...
    private void btnTextSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTextSaveMouseClicked
        ...
        layananService.create(layanan);
        JOptionPane.showMessageDialog(null, "Data layanan created successfully");
        loadData2();
        emptyField();
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        JOptionPane.showMessageDialog(null, "Data layanan updated successfully");
        loadData2();
        emptyField();
    ...
    private void btnPrintMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPrintMouseClicked
        // TODO add your handling code here:
        MessageFormat header = new MessageFormat("List Layanan");
        MessageFormat footer = new MessageFormat("Page {0, number, integer}");
        try {
            tabelLayanan.print(JTable.PrintMode.FIT_WIDTH, header, footer);
    ...
    private void loadData(Layanan layanan) {
        Object[][] objectLayanan = new Object[1][3];
        
        objectLayanan[0][0] = layanan.getId();
        objectLayanan[0][1] = layanan.getNama_layanan();
        objectLayanan[0][2] = layanan.getHarga();
            
        tabelLayanan.setModel(new javax.swing.table.DefaultTableModel(
            objectLayanan,
            new String [] {
                "ID Layanan", "Nama", "Harga"
            }
        ));
    }
    ...
    private void loadData2() {
        ...
        Object[][] objectLayanan = new Object[listLayanan.size()][3];
        
        int counter = 0;
        
        for (Layanan layanan : listLayanan) {
            objectLayanan[counter][0] = layanan.getId();
            objectLayanan[counter][1] = layanan.getNama_layanan();
            objectLayanan[counter][2] = layanan.getHarga();
            counter++;
        }
        tabelLayanan.setModel(new javax.swing.table.DefaultTableModel(
            objectLayanan,
